...
async def predictRouteClient(request: Request):
    ...
    try:
        ...
        status = "The client is likely to be interested in the insurance policy." if value == 1 else "The client is unlikely to be interested in the insurance policy at this time."
